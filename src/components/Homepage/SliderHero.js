                ...
                >
                    <SwiperSlide className={Mstyles.SwiperImgae}>
                        ...
                        <Link href={`/services/virtual-assistant`} >
                            ...
                            <div>
                                <img src='/img/slider1.jpg' alt='img' className={Mstyles.SliderimgDesktop} />
                                <img src='/img/sm1.jpg' alt='img' className={Mstyles.SliderimgMobile} />
                            </div>
                        </Link>
                    ...
                    <SwiperSlide className={Mstyles.SwiperImgae}>
                        ...
                        <Link href={`/services/website-development`} >
                            ...
                            <div>  <img src='/img/slider2.jpg' alt='img' className={Mstyles.SliderimgDesktop} />
                                <img src='/img/sm2.jpg' alt='img' className={Mstyles.SliderimgMobile} /></div>
                        </Link>
